...
mixin _$Products {
  ...
  List<ProductDatumFreezed>? get data => throw _privateConstructorUsedError;
...
class _$ProductsImpl implements _Products {
  _$ProductsImpl(
      ...
      final List<ProductDatumFreezed>? data,
  ...
  final List<ProductDatumFreezed>? _data;
  @override
  List<ProductDatumFreezed>? get data {
    final value = _data;
...
abstract class _Products implements Products {
  factory _Products(
      ...
      final int? to,
      final int? total}) = _$ProductsImpl;
